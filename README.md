...
Detect cellular regions using YOLO.

Extract the detected WBC and classify its subtype using an ensemble of ConvNeXt-Tiny models.
...
Training data with image degradation
...
Final test / leaderboard inference
...
Multiple WBCs are detected.

Detection confidence is too low.

Cell size is outside the accepted range.

The detected cell is incorrectly positioned.

The cell morphology/aspect ratio is considered unrealistic.
...
Running detection on generated images.

Extracting detection statistics.

Applying class-specific verification thresholds.

Accepting or rejecting synthetic images.
